...
import { CollidedArea, HighLightedUdm, InitialConfigRequest, InitialConfigResponse, LoadedUdm, NearestUdm, ServerPollingRequest, ServerPollingResponse } from "./Graphics/Utils/JsonResponses";
...
export class RunnerFGS {
  ...
  private timerHandler() {
    ...
    if(this.successfulConfiguration) {
      const serverReq: ServerPollingRequest = { position : new Point2d(0,0), rotation : 0, forkHeight: 0, isLoaded : false, loadDistance: 0}
